            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                <h2 className="text-center text-3xl font-extrabold text-gray-900">
                  {loading ? "Carregando..." : `${meta.titulo}`.toUpperCase()}
                </h2>
                <div className="my-4">
                <p className="text-gray-700">{`ID: ${id}`}</p>
                  <p className="text-gray-700">{`Descrição: ${meta.descricao}`}</p>
                  <p className="text-gray-700">{`Status: ${meta.status}`}</p>
                  <p className="text-gray-700">{`Data de inicio: ${meta.data_inicio}`}</p>
                  <p className="text-gray-700">{`Data de conclusão: ${meta.data_conclusao}`}</p>
